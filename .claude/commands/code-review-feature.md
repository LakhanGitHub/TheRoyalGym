...
description: Runs parallel security and quality code 
  review for a specific the royal gym app feature. Pass the spec 
...
**theroyalgym-security-reviewer** receives:
...
**theroyalgym-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[theroyalgym-security-reviewer output]
Quality Findings
[theroyalgym-quality-reviewer output]
