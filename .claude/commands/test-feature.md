---
description: Writes and runs tests for a specific the royal gym feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **theroyalgym-test-writer** subagent with the 
following context:
...
Wait for theroyalgym-test-writer to fully complete and 
...
Once theroyalgym-test-writer has finished, invoke the 
**theroyalgym-test-runner** subagent with the following 
context:
...
- If theroyalgym-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the theroyalgym-test-runner's structured report
